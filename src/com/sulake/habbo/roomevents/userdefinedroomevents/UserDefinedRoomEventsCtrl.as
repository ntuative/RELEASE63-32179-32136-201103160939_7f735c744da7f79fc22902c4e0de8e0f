package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_322:int = 3;
      
      private static var var_1345:int = 2;
      ...
      private var var_1632:TriggerConfs;
      
      private var var_1633:ActionTypes;
      
      private var var_1631:ConditionTypes;
      
      private var var_246:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_706:RoomObjectHightLighter;
      ...
      {
         this.var_1632 = new TriggerConfs();
         this.var_1633 = new ActionTypes();
         this.var_1631 = new ConditionTypes();
         this.var_246 = new Dictionary();
         super();
         this.var_81 = param1;
         this.var_706 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1075 = new SliderWindowController(this.var_81,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_81.assets,0,20,1);
         this.var_1075.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1075.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_706.hideAll(this.var_246);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_706.showAll(this.var_246);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1075.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_322)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1075.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1345) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1345 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_322)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1632);
         this.refreshConfigureElement(this.var_1633);
         this.refreshConfigureElement(this.var_1631);
