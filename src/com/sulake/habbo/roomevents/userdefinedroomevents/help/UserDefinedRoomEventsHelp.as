package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1037:IContainerButtonWindow;
      
      private var var_1038:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1548 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1038 = this.var_1548.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1038)
         {
            this.var_1038.procedure = this.onButtonClick;
         }
         this.var_1037 = this.var_1548.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1037)
         {
            this.var_1037.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_236 >= this.var_80.length - 1)
         {
            this.var_1037.disable();
         }
         else
         {
            this.var_1037.enable();
         }
         if(this.var_236 <= 0)
         {
      ...
      {
         ++this.var_236;
         this.var_236 = Math.min(this.var_236,this.var_80.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_236;
         this.var_236 = Math.max(this.var_236,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_80[this.var_236][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_80[this.var_236][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_80[this.var_236][1]).value;
