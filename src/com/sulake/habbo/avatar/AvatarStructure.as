package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_878:AvatarActionManager;
      ...
      private var var_880:ActionDefinition;
      
      private var var_478:String;
      
      private var var_1340:PartOffsetData;
      ...
      {
         this.var_1340.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_478);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_478);
            return;
         }
         this.var_878 = new AvatarActionManager(param1,this.var_478,param2);
         this.var_880 = this.var_878.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_478);
            return false;
         }
         if(this.var_408.parse(param1))
         {
            if(this.var_478 == AvatarType.const_125)
            {
               this.var_408.getPartDefinition("ri").appendToFigure = true;
               this.var_408.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_478);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_478);
            return false;
         }
      ...
      {
         return this.var_878.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_878.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_878.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_580[param1] = new Dictionary();
         }
         if(this.var_580[param1][param2])
         {
            return this.var_580[param1][param2];
         }
         this.var_580[param1][param2] = this.var_345.getMandatorySetTypeIds(param1,param2);
         return this.var_580[param1][param2];
      }
      ...
      {
         return this.var_878.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_408.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_408.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_408.getActiveParts(param3.definition);
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_880;
                           }
                           _loc12_ = this.var_408.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_408.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1340.getOffset(param1,param2,param3,param4,param5,param6);
      }
