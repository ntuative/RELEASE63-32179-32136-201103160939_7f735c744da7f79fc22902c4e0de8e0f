package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1261:IWindowContainer;
      
      public static var var_1525:IWindowContainer;
      
      public static var var_1990:int = 6710886;
      ...
      private var var_2479:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1145 = [];
         this.var_1370 = [AvatarEditorFigureCategory.const_758,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_244,AvatarEditorFigureCategory.const_638,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1261 == null)
         {
            ...
            var_1261 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1525 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1525 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_419 = new Timer(1000);
         this.var_419.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1370;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1370);
         }
         if(param1.length != this.var_1145.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1145.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2479 = this.canChangeOutfit();
            this.var_419.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1145.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1370;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && (this.var_1754 == AvatarEditorSideCategory.const_105 || this.var_2480))
         {
         ...
         this.setViewToCategory(this.var_331);
      }
      ...
      {
         if(this.var_1754 == AvatarEditorSideCategory.const_105)
         {
            this.var_2480 = false;
            this.setSideContent(AvatarEditorSideCategory.const_648);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_648:
               break;
            case AvatarEditorSideCategory.const_515:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_515);
               break;
