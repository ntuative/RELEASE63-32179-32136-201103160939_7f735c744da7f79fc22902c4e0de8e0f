package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1705:AvatarDataContainer;
      
      private var var_1385:Array;
      
      private var var_1706:DirectionDataContainer;
      
      private var var_1704:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1683 = String(param2.@desc);
         }
         else
         {
            this.var_1683 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1387.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1705 = new AvatarDataContainer(param2.avatar[0]);
         }
         ...
         {
            this.var_1704 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1386.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_730.push(new AddDataContainer(_loc6_));
            }
         }
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_673,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_673)
            {
      ...
      {
         return this.var_1387 != null;
      }
      
      public function hasAvatarData() : Boolean
      {
         return this.var_1705 != null;
      }
      ...
      {
         return this.var_1704 != null;
      }
      
      public function hasRemoveData() : Boolean
      {
         return this.var_1386 != null;
      }
      
      public function hasAddData() : Boolean
      {
         return this.var_730 != null;
      }
