package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_2665 = parseInt(_loc2_,16);
         ...
         this.var_962 = new ColorTransform(this.var_1711,this.var_1713,this.var_1710,this._alphaMultiplier);
         this.var_1208 = this.generatePaletteMapForGrayscale(this.var_2664,this.var_2665);
      }
      ...
      {
         return this.var_1208.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1208.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1208.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1208.getValue("alphas") as Array;
      }
