package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1283:String = "Default";
      
      private static const const_1285:int = 2;
      
      private static const const_1284:String = AvatarSetType.const_36;
      ...
      protected var var_1617:int;
      
      protected var include:IActiveActionData;
      ...
      protected var var_546:IAvatarDataContainer;
      
      protected var var_324:Array;
      
      protected var var_46:BitmapData;
      
      private var var_880:IActiveActionData;
      ...
      protected var var_1281:Boolean = false;
      ...
      private var var_2725:String = null;
      
      private var var_2727:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1284,const_1285);
         this.var_324 = new Array();
         this.var_880 = new ActiveActionData(AvatarAction.const_405);
         this.var_880.definition = this._structure.getActionDefinition(const_1283);
         this.resetActions();
      ...
      {
         param2 += this.var_1629;
         if(param2 < AvatarDirectionAngle.const_1233)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_654,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_272.length == 1 && this.var_89 == this.var_1617)
         {
            return this.var_89 + this.var_533 + this.var_654 % 4;
         }
         if(this.var_272.length == 2)
         {
            for each(_loc1_ in this.var_272)
            {
               ...
               {
                  return this.var_89 + this.var_533 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_654 % 11;
                  return this.var_89 + "_" + this.var_1617 + this.var_533 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2726 || param2 != this.var_2725 || param1 != this.var_2727)
         {
            this.var_2726 = param3;
            this.var_2725 = param2;
            this.var_2727 = param1;
            this.var_1948 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.include.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1281 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1281)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.include.definition.geometryType,this.var_89);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_654);
         ...
         {
            if(this.var_546.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_546.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.include.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.include.definition.geometryType,this.var_89);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_654);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_324.push(new ActiveActionData(param1,param2,this.var_654));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.include = this.var_880;
         this.include.definition = this.var_880.definition;
         this.resetBodyPartCache(this.var_880);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_533 = "";
         this.var_272 = this._structure.sortActions(this.var_324);
         if(this.var_272 == null)
         {
            this.var_703 = new Array(0,0,0);
            if(this.var_1503 != "")
            {
               _loc1_ = true;
               this.var_1503 = "";
         ...
         {
            this.var_703 = this._structure.getCanvasOffsets(this.var_272,this._scale,this.var_89);
            ...
            if(this.var_1503 != this.var_533)
            {
               _loc1_ = true;
               this.var_1503 = this.var_533;
            }
         }
         this.var_1344 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_272)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_881 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1629 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_546 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_303 || _loc1_.actionType == AvatarAction.const_250 || _loc1_.actionType == AvatarAction.const_378)
               {
                  this.var_881 = true;
               }
            }
