package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1979:int = 10;
      ...
      private const const_1700:uint = 4.294967295E9;
      
      private const const_1978:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1571 = _loc1_.stuffTypes;
            this.var_688 = _loc1_.boxTypes;
            this.var_689 = _loc1_.method_3;
            this.var_1050 = this.var_1571[0];
            this.var_335 = this.var_688[0];
            this.var_334 = this.var_689[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_334 < 0)
         {
            this.var_334 = this.var_689.length - 1;
         }
         if(this.var_334 > this.var_689.length - 1)
         {
            this.var_334 = 0;
         }
         if(this.var_335 < 0)
         {
            this.var_335 = this.var_688.length - 1;
         }
         if(this.var_335 > this.var_688.length - 1)
         {
            this.var_335 = 0;
         }
         var _loc1_:int = this.var_688[this.var_335] * 1000 + this.var_689[this.var_334];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1571;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_92);
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_688[this.var_335]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_689[this.var_334]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_90,this.var_1312,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_90.offerId,this.var_1312);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               for each(_loc7_ in this.var_211)
               {
                  ...
                  if(_loc5_.length >= this.const_1979)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2122 = _loc3_.text;
               break;
            ...
            case WindowKeyboardEvent.const_351:
               ...
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_336 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_336 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_336) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_561 == null)
         {
            this.var_561 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_561.procedure = this.suggestionsEventHandler;
         }
         if(this.var_239 == null || this.var_561 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_561.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_336) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_336);
         }
         this.var_336 = param1;
         if(this.var_336 < 0)
         {
            this.var_336 = _loc2_.numListItems - 1;
         }
         if(this.var_336 >= _loc2_.numListItems)
         {
            this.var_336 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_336) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1978;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1699) : uint(this.const_1700);
      }
