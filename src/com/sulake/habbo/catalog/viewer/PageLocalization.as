package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1309:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_1310:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_946:Object = {"frontpage3":[7,8]};
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_729.length)
         {
            _loc2_ = String(this.var_729[param1]).replace("#","0x");
