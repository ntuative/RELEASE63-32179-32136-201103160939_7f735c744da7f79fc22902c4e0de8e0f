package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_919 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1130 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1721 = new Point(this.var_86.x,this.var_86.y);
         ...
         this.var_1722 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_919.text = _loc4_;
         this.var_1130.text = _loc5_;
         this.var_919.height = this.var_919.textHeight + 5;
         this.var_1130.y = this.var_919.y + this.var_919.height;
         this.var_1130.height = Math.max(130,this.var_1130.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_539:
                  _loc6_ = this.var_1722.clone();
                  if(this.var_492 != null)
                  {
                     this.var_492.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_492,this.var_1391,this.var_1891);
                     ...
                     case ProductTypeEnum.const_239:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_324,AvatarAction.const_464);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2440)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2440 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1721.x;
            this.var_86.y = this.var_1721.y;
            if(param3 != null)
            {
