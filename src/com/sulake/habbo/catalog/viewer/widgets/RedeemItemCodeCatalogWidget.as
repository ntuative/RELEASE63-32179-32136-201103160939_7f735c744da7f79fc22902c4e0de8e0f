package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_971.removeEventListener(WindowKeyboardEvent.const_173,this.windowKeyEventProcessor);
            this.var_971 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_971 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_971 != null)
         {
            this.var_971.addEventListener(WindowKeyboardEvent.const_173,this.windowKeyEventProcessor);
         }
         return true;
      }
