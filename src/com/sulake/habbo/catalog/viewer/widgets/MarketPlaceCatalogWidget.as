package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1714:int = 1;
      
      private const const_1713:int = 2;
      
      private const const_2007:int = 40;
      
      private const const_2006:int = 10;
      
      private var var_750:Array;
      
      private var var_1424:MarketPlaceOfferData;
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_612)
         {
            ...
            this.var_612 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_612)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1713,_loc2_.length);
         if(!this.var_503)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1160 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1160));
            ++this.var_1160;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_612 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_612.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1714);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_104)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2006;
                  break;
               case "search_input":
                  _loc8_ = this.const_2007;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1424.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_64)
