package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1266:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1313:XML;
      
      private static var var_1314:XML;
      ...
      private var var_2818:IWindowContainer;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1314 == null)
         {
            ...
            var_1314 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1572 == 4294967295)
            {
               this.var_1572 = _loc1_.color;
            }
            _loc1_.color = const_1266;
         }
      }
      ...
      {
         this.var_61 = navigator.catalog.windowManager.buildFromXML(var_1314) as IItemListWindow;
         if(this.var_61 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1313) as IWindowContainer;
         }
         else
         {
