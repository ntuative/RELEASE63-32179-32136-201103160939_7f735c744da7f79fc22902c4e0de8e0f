package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1152:TextFieldManager;
      
      private var var_44:Array;
      
      private var var_1151:RoomLayout;
      
      private var var_611:Timer;
      
      private var var_1767:Boolean = true;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1151.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1767 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1767 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_61 = IItemListWindow(this.var_181.findChildByName("item_list"));
         ...
         this.var_1152 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_181.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1152.goBackToInitialState();
         this.var_1152.input.textBackgroundColor = 4294967295;
         this.var_1151 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1152.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1152.getText();
         var _loc3_:String = "model_" + this.var_1151.name;
