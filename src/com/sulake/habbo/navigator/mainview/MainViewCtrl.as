package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_941:int = 1;
      
      private static const const_601:int = 2;
      ...
      private var var_899:GuestRoomListCtrl;
      
      private var var_1110:OfficialRoomListCtrl;
      ...
      private var var_1373:IWindow;
      
      private var var_1111:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_899 = new GuestRoomListCtrl(this._navigator);
         this.var_1110 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_181 = IWindowContainer(this.var_17.findChildByName("tab_content"));
         this.var_217 = IWindowContainer(this.var_17.findChildByName("custom_content"));
         this.var_205 = IWindowContainer(this.var_17.findChildByName("list_content"));
         this.var_254 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1373 = this.var_17.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_17.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1111 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(!this.var_1111)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1111.procedure = this.onHotelView;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1557,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_181,["custom_content","list_content"],this.var_217.y,8);
         this.var_205.height = this.var_205.height + _loc1_ - this.var_205.y - this.var_254.height + this.var_2381;
         Util.moveChildrenToColumn(this.var_181,["list_content","custom_footer"],this.var_205.y,0);
         this.var_2381 = this.var_254.height;
      ...
      {
         this.refreshList(param1,param2,this.var_899,"guest_rooms");
      }
      ...
      {
         this.refreshList(param1,param2,this.var_1110,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_592 == const_941)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_205.blend - _loc2_));
            this.var_205.blend = _loc3_;
            this.var_217.blend = !!this.var_1109 ? Number(_loc3_) : Number(1);
            this.var_254.blend = !!this.var_1109 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_592 = const_601;
            }
         }
         else if(this.var_592 == const_601)
         {
            if(this.var_1374 % 10 == 1)
            {
               this.var_1373.visible = !this.var_1373.visible;
            }
            ++this.var_1374;
            if(!this._navigator.data.isLoading())
            {
               this.var_592 = const_940;
            }
         }
         else if(this.var_592 == const_940)
         {
            this.refresh();
            this.var_592 = const_1307;
         }
         else
         {
            this.var_1373.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_205.blend + _loc2_));
            this.var_205.blend = _loc3_;
            this.var_217.blend = !!this.var_1109 ? Number(_loc3_) : Number(1);
            this.var_254.blend = !!this.var_1109 ? Number(_loc3_) : Number(1);
      ...
      {
         this._navigator.refreshButton(this.var_1111,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1111,"icon_hotelview_reactive",param1,null,0);
      }
