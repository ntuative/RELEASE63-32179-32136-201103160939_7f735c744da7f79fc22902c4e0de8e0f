package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1946 = IButtonWindow(this.find("bg_tab"));
         this.var_1945 = IButtonWindow(this.find("top_tab"));
         this.var_1947 = IButtonWindow(this.find("obj_tab"));
         this.var_2724 = IWindowContainer(this.find("tile_grid"));
         ...
         Util.setProcDirectly(this.var_1946,this.onBgTabButton);
         Util.setProcDirectly(this.var_1945,this.onTopTabButton);
         Util.setProcDirectly(this.var_1947,this.onObjTabButton);
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_69.mode = ThumbnailEditorModel.const_59;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1946,this.var_69.mode != ThumbnailEditorModel.const_38);
         this.setEnabled(this.var_1945,this.var_69.mode != ThumbnailEditorModel.const_59);
         this.setEnabled(this.var_1947,this.var_69.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function refreshEditArea() : void
      {
         ...
         this.refreshEditImg(_loc1_,"edit_top",this.var_69.mode == ThumbnailEditorModel.const_59);
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_425,HabboWindowStyle.const_42,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_291,HabboWindowStyle.const_42,HabboWindowParam.const_61,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
