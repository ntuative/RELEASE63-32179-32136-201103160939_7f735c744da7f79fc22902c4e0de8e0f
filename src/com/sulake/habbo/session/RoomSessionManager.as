package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1840)
         {
            this.gotoRoom(this.var_2599,this.var_2600,this.var_1841);
            this.var_1840 = false;
            this.var_1841 = "";
         }
      }
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1084:
                  break;
               case RoomSessionHandler.const_1189:
                  break;
               case RoomSessionHandler.const_666:
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_100,_loc4_));
            _loc4_.dispose();
         }
      }
