package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_483:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_483 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         this.var_1089 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         this.var_483.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1089.load(_loc4_,this.var_157.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_66 != null && this.var_66.issueManager != null && this.var_157 != null)
         {
            this.var_66.issueManager.removeHandler(this.var_157.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_157.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_157.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_157.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.releaseBundle(this.var_157.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_66,WindowTracker.const_1013,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_483 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
            this.var_483.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
