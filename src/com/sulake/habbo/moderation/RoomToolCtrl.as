package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1328:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_348));
         Logger.log("BEGINNING TO SHOW: " + this.var_348);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1561;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_348);
         if(param1.flatId != this.var_348)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_348);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1328 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1329 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_699,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1433,_loc2_,this.var_463.text,"",""));
         if(this.var_1328.isSelected || this.var_1329.isSelected || this.var_868.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1328.isSelected,this.var_1329.isSelected,this.var_868.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1664);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1512);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1061.selection];
         if(_loc3_ != null)
         {
            this.var_623 = false;
