package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1652:int = 2;
      
      public static const const_1013:int = 3;
      
      public static const const_699:int = 4;
      
      public static const const_1035:int = 5;
      ...
      public static const const_1561:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1558[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1558[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
