package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_922:Array = [];
      ...
      {
         this.var_738 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_922.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_738.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_922.length < var_1737)
         {
            ...
            param1.width = this.var_738.width;
            param1.height = this.var_738.height;
            var_922.push(param1);
         }
         else
         {
