package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_800:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2213 = param2.pickerUserId;
         this.var_2699 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1228 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1229;
         }
         if(this.var_800 == null || param1.timeStamp < this.var_800.timeStamp)
         {
            this.var_800 = param1;
         }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1228 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1229;
            }
            if(this.var_800 == _loc2_)
            {
               this.var_800 = null;
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_800;
         if(_loc2_ == null)
         {
