package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1605:IAlertDialog;
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         if(this.var_65.toolbar != null)
         {
            ...
            {
               this.var_65.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
