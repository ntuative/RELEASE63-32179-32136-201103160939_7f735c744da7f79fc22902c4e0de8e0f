package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1773:int = "F".charCodeAt(0);
      
      public static const const_1841:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_799 = param1.online;
         this.var_1827 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1923 = param1.motto;
         this.var_1925 = param1.lastAccess;
         this.var_1400 = param1.categoryId;
         this.var_1924 = param1.realName;
