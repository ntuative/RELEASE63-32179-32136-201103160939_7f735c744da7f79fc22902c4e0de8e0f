package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1071)
         {
            this.var_1071.release(new IIDAvatarRenderManager());
            this.var_1071 = null;
         }
         if(this.var_909)
         {
            this.var_909.release(new IIDHabboNotifications());
            this.var_909 = null;
         }
         if(this.var_179)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1940 = new OpenedToWebPopup(this);
         }
         this.var_1940.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_384.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_291,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1071.createAvatarImage(param1,AvatarScaleType.const_86,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1071 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_909 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_384 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_99.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_99.addCategory(new FriendCategory(FriendCategory.const_1031,this.getText("friendlist.friends")));
         this.var_99.addCategory(new FriendCategory(FriendCategory.const_402,this.getText("friendlist.friends.offlinecaption")));
         ...
         this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_99.findCategory(FriendCategory.const_402);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_389));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_384.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_384.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_434.findTab(FriendListTab.const_101).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_384.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_434.findTab(FriendListTab.const_101);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1939.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_434.findTab(FriendListTab.const_101);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_806 || !this.var_384)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_806.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this.var_384.vipLimit;
         }
         else if(this.var_806.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_384.clubLimit;
         }
         if(_loc2_ > this.var_384.limit)
         {
            this.var_384.limit = _loc2_;
         }
      }
