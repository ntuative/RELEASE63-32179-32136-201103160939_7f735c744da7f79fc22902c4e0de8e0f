package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1743:String = "no_reqs_info";
      ...
      {
         this.var_1971 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1970 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1970.procedure = this.onDismissAllButtonClick;
         this.var_1971.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_170)
         {
         ...
         else if(param1.state == FriendRequest.const_1059)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_339 && _loc4_.state != FriendRequest.const_335)
            {
