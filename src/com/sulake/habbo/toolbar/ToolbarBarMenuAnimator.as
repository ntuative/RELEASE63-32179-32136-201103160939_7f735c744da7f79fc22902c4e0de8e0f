package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_214:Boolean = true;
      
      private static const const_1329:Number = 25;
      
      private static const const_1330:Number = 90;
      
      private static const const_979:int = 50;
      
      private static const const_1366:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1487:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_646 = new Object();
         this.var_644 = new Array();
         this.var_645 = new Array();
         super();
         this._windowManager = param1;
         this.var_1487 = param2;
         this.var_791 = new Timer(const_1329);
         this.var_791.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_979 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_979 || param1.desktop.height - param1.y < const_1366;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1487.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1487.getIconLoc(param1.iconId);
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_645.indexOf(param2);
         if(_loc3_ > -1)
         {
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_646[_loc3_] == null)
            {
               this.var_646[_loc3_] = new Array();
            }
            if(this.var_646[_loc3_].indexOf(param1) < 0)
            {
               this.var_646[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_644.length)
         {
            ...
            {
               _loc3_ = this.var_645[_loc2_];
               if(this.var_646[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_646[_loc3_].length)
                  {
                     this.repositionWindow(this.var_646[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
