package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher)
      {
         ...
         this.var_166 = this._window.width;
         this.var_224 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_62,HabboWindowStyle.const_1187,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1170 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(this.var_1170)
         {
         ...
         this.var_1169 = _loc7_.toolbar.@margin_top;
         this.var_1439 = _loc7_.toolbar.@margin_bottom;
         this.var_1808 = _loc7_.toolbar.@min_group_margin;
         this.var_1809 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc8_,this.var_261,param1,param2,param3,this._window,this.var_316);
         this.createGroupsFromXmlList(_loc9_,this.var_617,param1,param2,param3,this.var_224,this.var_316);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_166);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_166,this.var_506,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_506);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_166,this.var_506);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_166,this.var_506);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_1053);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_224.x = this.var_166 + this.var_1809;
               this.var_224.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_166;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_166;
               this._window.y = 0;
               this.var_224.x = 0;
               this.var_224.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_166;
               this._window.x = 0;
               this._window.y = 0;
               this.var_224.x = 0;
               this.var_224.y = this.var_166 + this.var_1809;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_166;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_166;
               this.var_224.x = 0;
               this.var_224.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1439;
         _loc4_ -= this.var_1169;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1169;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_261.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1808,(this._window.height - _loc5_ * _loc8_ - this.var_1169 - this.var_1439) / (this.var_261.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1808,(this._window.width - _loc5_ * _loc8_ - this.var_1169 - this.var_1439) / (this.var_261.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_261.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_506;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_166)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_166)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_166)
         {
            return "BOTTOM";
         }
         return null;
