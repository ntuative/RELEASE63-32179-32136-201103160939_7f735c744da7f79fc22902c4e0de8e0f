package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1394:LogoutController;
      ...
      {
         this.var_16 = new ToolbarView(this._windowManager,this._assetLibrary,this.var_290.getHabboMainConnection(null),events);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            this.var_1394 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_16 == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1148,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_150,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1067,this.onHideWindowEvent);
         this._state = true;
