package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_824:int = 0;
      
      protected var var_664:BitmapData;
      
      protected var var_2287:int;
      
      protected var var_1530:Boolean;
      
      protected var var_2044:Boolean;
      
      protected var var_2806:BitmapData;
      
      private const const_1981:int = 8947848;
      
      private const const_1980:int = 13421772;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2807 == FurniModel.const_44)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1462));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2028);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_689)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(this.var_2044 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2806;
               _loc5_.visible = true;
            }
            else
            {
