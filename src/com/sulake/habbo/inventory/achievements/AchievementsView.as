package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_61 = IItemListWindow(this.var_16.getChildByName("achievements_itemlist"));
         this.var_415 = new Timer(1000,1);
         this.var_415.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_415)
            {
               this.var_415.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_415.reset();
               this.var_415 = null;
            }
            this._disposed = true;
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         _loc4_.text = this._localization.method_12(param2.badgeId,param2.scoreLimit);
         _loc4_.visible = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_415.running);
         this.var_1118[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1118[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_307.getBadgeImage(param2.badgeId);
            this.var_1118[param2.badgeId] = _loc4_;
         }
