package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1046:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1047 = this.var_16.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1047.procedure = this.inactiveGridEventProc;
         this.var_1046 = this.var_16.findChildByName("active_items") as IItemGridWindow;
         this.var_1046.procedure = this.activeGridEventProc;
      }
      ...
      private function updateListViews() : void
      {
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            this.var_1046.addGridItem(_loc2_.window);
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = this.var_1046.getGridItemIndex(param1.window);
