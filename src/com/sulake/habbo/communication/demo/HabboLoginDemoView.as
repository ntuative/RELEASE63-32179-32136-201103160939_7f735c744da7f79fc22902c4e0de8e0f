package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_423:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_161.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_136,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1702,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1702,"/");
         ...
         {
            dispatchEvent(new Event(const_423));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_131.removeEventListener(SSOTicket.const_398,this.onParsedTicketSuccess);
            this.var_131.removeEventListener(SSOTicket.const_318,this.onParsedTicketFailure);
            this.var_131 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_131 = new SSOTicket(this.var_161.assets,_loc3_,_loc2_,param1);
         this.var_131.addEventListener(SSOTicket.const_398,this.onParsedTicketSuccess);
         this.var_131.addEventListener(SSOTicket.const_318,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_161.shockwaveClientUrl = this.var_131.shockwaveClientUrl;
         this.var_161.ssoTicket = this.var_131.ticket;
         this.var_131.removeEventListener(SSOTicket.const_398,this.onParsedTicketSuccess);
         this.var_131.removeEventListener(SSOTicket.const_318,this.onParsedTicketFailure);
         this.var_131 = null;
         dispatchEvent(new Event(const_423));
