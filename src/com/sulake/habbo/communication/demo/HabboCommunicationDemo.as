package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2284:PseudoRandom;
      ...
      private const const_1702:String = "fuselogin";
      ...
      {
         if(param1 && !this.var_581)
         {
            this.var_581 = param1;
            this.var_57.initConnection(HabboConnectionType.const_245);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_100,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_57 && this.var_153 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_581 = this.var_153.getKey("sso.ticket",null);
         this.var_1634 = this.var_153.getKey("flash.client.url","");
         this.var_2286 = this.var_153.getKey("external.variables.txt","");
         if(this.var_214 == null)
         {
            this.var_214 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_57.mode = HabboConnectionType.const_89;
            if(this.var_581)
            {
               this.var_57.initConnection(HabboConnectionType.const_245);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_16.addEventListener(HabboLoginDemoView.const_423,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1072;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_245);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_868);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2284 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_89:
               ...
               this.var_214.loadBannerImage(_loc7_ + "?token=" + this.var_1349,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1072:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1663:
               this.var_884 = this.generateRandomHexString(30);
               this.var_479 = new DiffieHellman(new BigInteger(this.var_153.getKey("connection.development.prime"),16),new BigInteger(this.var_153.getKey("connection.development.generator"),16));
               this.var_479.init(this.var_884);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2284);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1634,this.var_2286));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1702,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_581 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_581);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2285)
         {
