package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1270:int = 10;
      
      private static const const_925:int = 100;
      
      private static const const_1269:int = 20;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_141 = param1;
         this.var_1580 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_61 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2136 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_925 + const_1269)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1270;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1580.enable();
         }
         else
         {
            this.var_1580.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_61.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_473.messages.length - const_925);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_845 || param3.type == Message.const_647 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_141.send(new FollowFriendMessageComposer(this.var_473.id));
      }
