package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_908:int = 70;
      ...
      private static const const_937:int = 3;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1660 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1660 = 15;
         }
         this.var_1661 = this._window.height;
         this.var_713 = 4;
         this.var_714 = 0;
         this._state = name_2;
         this.var_179 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_552:
               ...
               _loc2_ = Number(this.var_1094) / Number(this.var_412["time_fade_in"]);
               if(this.var_1094 > int(this.var_412["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_936:
               ...
               if(this.var_1362 > int(this.var_412["time_display"]) && !this.var_1659)
               {
                  this.startFadeOut();
               }
               break;
            case const_937:
               ...
               _loc3_ = 1 - Number(this.var_1093) / Number(this.var_412["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1093 > int(this.var_412["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1660;
         if(this._window.height < this.var_1661)
         {
            this._window.height = this.var_1661;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_179.orientation == "TOP" ? int(const_415) : 0;
         var _loc4_:int = this.var_179.orientation == "BOTTOM" ? int(_loc2_.height - const_415) : int(_loc2_.height);
         var _loc5_:int = this.var_179.orientation == "LEFT" ? int(const_415) : 0;
         var _loc6_:int = this.var_179.orientation == "RIGHT" ? int(_loc2_.width - const_415) : int(_loc2_.width);
         if(this.var_412["position_horizontal_follow_toolbar"] == "true" && (this.var_179.orientation != "TOP" && this.var_179.orientation != "BOTTOM"))
         {
            if(this.var_179.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_504;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_504;
            }
         }
         else if(this.var_412["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_504;
         }
         else
         ...
         if(this.var_412["position_vertical_follow_toolbar"] == "true" && (this.var_179.orientation != "RIGHT" && this.var_179.orientation != "LEFT"))
         {
            if(this.var_179.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_713;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_713;
            }
         }
         else if(this.var_412["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_713;
         }
         else
