package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1335:String = "pixelbalance";
      
      private static const const_1340:String = "badges";
      
      private static const const_1337:String = "selectbadge";
      
      private static const const_1339:String = "inventory";
      
      private static const const_1333:String = "selectfurni";
      
      private static const const_1334:String = "credits";
      
      private static const const_1338:String = "friendlist";
      ...
      private var var_757:IHabboToolbar;
      ...
      private var var_505:HabboNotificationViewManager;
      
      private var var_223:HabboAlertDialogManager;
      
      private var var_756:ParkBusDialogManager;
      
      private var var_2554:Boolean;
      
      private var var_943:ClubGiftNotification;
      
      private var var_945:ClubEndingNotification;
      
      private var var_946:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_944);
         }
         var _loc6_:Map = this.var_944["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_757)
         {
            this.var_757.release(new IIDHabboToolbar());
            this.var_757 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_944["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_757 = IHabboToolbar(param2);
         this.var_757.events.addEventListener(HabboToolbarEvent.const_73,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_73)
         {
            ...
            this.var_505 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_944["styles"],this.var_944["view"],this.var_757);
            ...
            registerUpdateReceiver(this.var_505,1);
            registerUpdateReceiver(this,2);
            this.var_307.events.addEventListener(BadgeImageReadyEvent.const_146,this.onBadgeImage);
            this.var_757.events.addEventListener(HabboToolbarEvent.const_421,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1434[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_307);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1434[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1434[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1502,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_307.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_994,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_994,null);
            }
         }
      }
      ...
      private function onBadgeReceived(param1:BadgeReceivedMessageEvent) : void
      {
         ...
         if(this.var_307.userId == _loc3_)
         {
            ...
            _loc9_ = this.var_307.getBadgeImage(_loc4_);
            this.addItem(!!_loc6_ ? _loc6_.value : "notifications.text.received.badge",NotificationType.const_637,_loc9_,_loc4_);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_481.createAvatarImage(param2,AvatarScaleType.const_58);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               if(_loc8_.productType == CatalogPageMessageProductData.const_92)
               {
                  _loc9_ = this.var_307.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_85)
               {
                  _loc9_ = this.var_307.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_307.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            case CatalogPageMessageProductData.const_92:
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1558)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_945 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_946 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_505.isSpaceAvailable() && this.var_1168.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_505.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_505 != null)
         {
            this.var_505.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_756 == null)
         {
            this.var_756 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_756 != null)
         {
            this.var_756.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1010,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1010,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_481.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_58);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2554)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_637,null);
            this.var_2554 = true;
      ...
      {
         if(param2.type == WindowEvent.const_191 || param2.type == WindowEvent.const_760)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_943 && this.var_943.visible)
         {
            return;
         }
         this.var_943 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_637,_loc6_);
      }
   }
}
