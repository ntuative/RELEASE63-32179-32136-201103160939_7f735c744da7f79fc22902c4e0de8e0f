package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_1976:int = 1000;
      ...
      private var var_837:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_207 = new Timer(this.const_1976);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_175.isActive)
         {
            ...
            this.var_838.width = _loc2_ * this.var_285;
         }
         else
         {
            this.var_838.width = 0;
            this.var_207.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_676 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_676 == null)
            {
               return;
            }
         ...
         if(!this.var_175.isActive)
         {
            this.var_676.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_676.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_676.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_837 = this._window.findChildByName("effect_hilite");
            this.var_837.visible = false;
         }
         this.setTimeLeft();
         this.var_838 = this._window.findChildByName("loader_bar");
         if(this.var_838 != null)
         {
            this.var_285 = this.var_838.width;
            this.var_207.start();
            this.onUpdate();
         }
