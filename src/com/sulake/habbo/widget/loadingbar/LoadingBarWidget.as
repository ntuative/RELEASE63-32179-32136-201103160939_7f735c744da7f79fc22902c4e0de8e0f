package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_500:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_500.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_500 = null;
         }
         if(this.var_46 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_500 == null)
         {
            this.var_500 = new Sprite();
            this.var_500.addChild(new Bitmap(this.var_46));
            this.var_500.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_500.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_46;
            }
         }
         _loc2_.setDisplayObject(this.var_500);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1049 != "")
         {
            HabboWebTools.openWebPage(this.var_1049);
         }
      }
   }
}
