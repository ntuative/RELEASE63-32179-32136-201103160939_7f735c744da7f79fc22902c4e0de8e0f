package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1996:int = 152;
      
      private const const_1986:int = 16;
      
      private const const_1286:int = 4;
      
      private const const_1994:uint = 14342874;
      
      private const const_1998:uint = 3815994;
      
      private const const_1987:uint = 2085362;
      
      private const const_1989:uint = 39616;
      
      private const const_1991:uint = 10513106;
      
      private const const_1993:uint = 8734654;
      
      private const const_1995:uint = 9094430;
      
      private const const_1997:uint = 6200576;
      
      private const const_1992:String = "happiness";
      
      private const const_1990:String = "experience";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1992,param1.nutrition,param1.nutritionMax,this.const_1989,this.const_1987);
         this.updateStateElement(this.const_1990,param1.experience,param1.experienceMax,this.const_1993,this.const_1991);
         this.updateStateElement(this.const_1988,param1.energy,param1.energyMax,this.const_1997,this.const_1995);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1996,this.const_1986,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1994);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1998);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1286,_loc7_.width - 2,_loc7_.height - 2 - this.const_1286);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1286);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_202.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_202.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_202.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_201 && this.var_201.getPetId() == this.var_532)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1395,true);
