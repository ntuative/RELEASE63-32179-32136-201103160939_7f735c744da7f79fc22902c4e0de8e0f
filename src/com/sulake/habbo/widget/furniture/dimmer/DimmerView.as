package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1481:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_641:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_62,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1267,const_1268,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_641 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_435 != null)
         {
            this.var_435.setValue(this.var_1480);
         }
         this.var_487 = this.colors.indexOf(_loc2_.color);
         if(this.var_641 != null)
         {
            this.var_641.setSelectedColorIndex(this.var_487);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1481 = XML(_loc1_.content);
         return this.var_1481;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_641 != null)
         {
            this.var_641.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
