package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_646,RoomWidgetEcotronBoxOpenMessage.const_799,RoomWidgetEcotronBoxOpenedMessage.const_1456];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_646:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_799:
