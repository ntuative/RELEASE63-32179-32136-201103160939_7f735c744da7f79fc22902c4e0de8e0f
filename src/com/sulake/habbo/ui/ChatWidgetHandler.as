package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      {
         return [RoomWidgetChatMessage.const_896,RoomWidgetChatSelectAvatarMessage.const_704];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_896:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_43) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1104))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_43) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1104))
                              {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1235 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1235);
            }
            if(this.var_805 == null)
            {
               ...
               this.var_526.y = 0;
               this.var_526.z = 0;
               this.var_805 = _loc4_.getScreenPoint(this.var_526);
               this.var_1235 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_526.x = 0;
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1931.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1931.remove(param1);
         if(_loc3_ != null)
         {
