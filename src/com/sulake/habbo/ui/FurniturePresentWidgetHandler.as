package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1302:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_763,RoomWidgetPresentOpenMessage.const_161,RoomWidgetPresentOpenedMessage.const_1391];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_325:
                  ...
                  if(_loc2_ != null)
                  {
                     this._name = "";
                     _loc4_ = null;
                     if(_loc2_.itemType == ProductTypeEnum.const_92)
                     {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_85:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_465,0,this._container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1302)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_376:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_551,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
