package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_823,RoomWidgetViralFurniMessage.const_910,RoomWidgetViralFurniMessage.const_161];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_823:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_460);
                     _loc8_ = "+";
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_548,RoomSessionViralFurniStatusEvent.const_488];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_548:
               ...
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_852);
