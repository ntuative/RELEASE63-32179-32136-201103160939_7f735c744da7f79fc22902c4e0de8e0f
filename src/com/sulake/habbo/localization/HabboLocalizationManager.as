package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private static var var_1472:String = "%";
      ...
      {
         this.var_1950 = new Dictionary();
         this.var_2728 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1949 = (param2 & 0) > 0;
         if(!this.var_1949)
         {
            lock();
         }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1472);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1472,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      public function method_12(param1:String, param2:int) : String
      {
      ...
      {
         this.var_1950[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1950[param1];
      }
      ...
      {
         return this.var_2728[Math.max(0,param1 - 1)];
      }
   }
}
