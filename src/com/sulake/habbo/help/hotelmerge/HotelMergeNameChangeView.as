package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1770:uint = 11129827;
      ...
      private var var_1155:NameSuggestionListRenderer;
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_817:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_819:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1018 || param1 == ChangeUserNameResultMessageEvent.var_1019)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1155 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1155.render(param3,_loc5_);
         var _loc7_:int = 0;
