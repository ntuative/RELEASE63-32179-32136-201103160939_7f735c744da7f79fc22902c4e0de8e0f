package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private var var_1064:Rectangle = null;
      ...
      public function render(param1:Array, param2:IWindowContainer) : int
      {
         ...
         this._offsetX = 0;
         this.var_1063 = 0;
         this.var_1064 = param2.rectangle.clone();
         this.var_1064.height = 150;
         var _loc4_:int = 0;
      ...
      {
         if(param1.width > this.var_1064.width)
         {
            return false;
         }
         if(this.var_1063 + param1.height > this.var_1064.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1064.width)
         {
            this._offsetX = 0;
            this.var_1063 += param1.height + this.const_1984;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1063);
         this._offsetX += param1.width + this.const_1983;
         return true;
      }
