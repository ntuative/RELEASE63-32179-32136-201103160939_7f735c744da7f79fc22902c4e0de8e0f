package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_908:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1066,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_907.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_997:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1657:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1150:
               ...
               case HabboSoundTypesEnum.const_1110:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1545:
            ...
            this.var_907.add(param1,_loc2_);
         }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_909.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_909 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_177 == null || this._connection == null || this._roomEngine == null || this.var_491 != null)
         {
            return;
         }
         this.var_491 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         if(this.var_599.length == 0 && this.var_725 != -1)
         {
            this.var_908.ready = true;
            _loc7_ = this.var_725;
            this.var_725 = -1;
            this.var_908 = null;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1066,_loc7_));
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_491.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1499,this.var_725));
         this.var_725 = -1;
         this.var_908 = null;
      }
      ...
      {
         this._volume = param1;
         this.var_491.updateVolume(this._volume);
