package com.sulake.habbo.sound.music
{
   ...
   public class RoomItemPlayListController implements IPlayListController, IDisposable
   {
      ...
      private var var_491:HabboMusicController;
      ...
      public function RoomItemPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_762,this.onSongFinishedPlayingEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_622,this.onSoundMachinePlayEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_893,this.onSoundMachineStopEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_855,this.onJukeboxStopEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_555,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_762,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_81)
            {
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_622,this.onSoundMachinePlayEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_893,this.onSoundMachineStopEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_855,this.onJukeboxStopEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_555,this.onDisposeEvent);
               this.var_81 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_356);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_491.requestSongInfo(_loc2_.id);
            }
         }
      }
      ...
      {
         this.var_491.stop(HabboMusicPrioritiesEnum.PRIORITY_ROOM_PLAYLIST);
         this.var_356 = -1;
         this.var_728 = false;
      }
      ...
      {
         var _loc2_:IHabboSound = this.var_491.getSongObject(this.var_356);
         if(_loc2_ != null)
         {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_491.playSong(param1,this.priority,_loc3_))
         {
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_491.playSong(_loc3_.currentSongId,this.priority,_loc3_.syncCount / 1000);
            this.var_356 = _loc3_.currentSongId;
         }
         if(_loc3_.nextSongId >= 0)
         {
            this.var_491.requestSongInfo(_loc3_.nextSongId);
         }
         this.var_728 = true;
         this.var_508.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_846,_loc3_.currentSongId));
