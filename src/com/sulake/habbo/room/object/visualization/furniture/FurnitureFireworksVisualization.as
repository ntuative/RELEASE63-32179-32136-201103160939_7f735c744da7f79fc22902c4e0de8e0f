package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_231:FurnitureParticleSystem;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_649)
         {
            for each(_loc1_ in this.var_649)
            {
               _loc1_.dispose();
            }
            this.var_649 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_231 = this.var_649[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_231)
         {
            this.var_231.setAnimation(param1);
         }
      ...
      {
         if(this.var_231 && this.var_231.controlsSprite(param3))
         {
            return this.var_231.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_991);
         if(_loc3_.length == 0)
         {
