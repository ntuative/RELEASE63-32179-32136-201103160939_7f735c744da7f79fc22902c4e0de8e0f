package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_859:IPlaneRasterizer = null;
      
      private var var_788:PlaneMaskManager = null;
      ...
      private var var_406:PlaneBitmapData = null;
      ...
      private var var_693:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2138 = param9;
         this.var_2139 = param10;
      ...
      {
         return this._isVisible && this.var_693;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_859.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_406;
         if(_loc3_ == null)
         {
         ...
         if(this.var_693 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_338))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_311.length * param1.scale;
            ...
            if(this.var_859 != null)
            {
               _loc3_ = this.var_859.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1584,this.var_2138,this.var_2139,this.var_2142,this.var_2141,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1716 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_693)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1320.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1320[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_152.z - originZ,this.var_113.z - originZ,this.var_85.z - originZ,this.var_112.z - originZ);
            if(this._type == const_99)
            {
               relativeDepth += 0.02;
            }
            this.var_2137 = relativeDepth;
            this._isVisible = true;
            this.var_1716 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2140);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_124 || this._type == const_99)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_124 || this._type == const_99))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(this.var_339.length > this.var_1319.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_860 || this.var_241.length == 0 && this.var_339.length == 0 && !this.var_338 || this.var_788 == null)
         {
            return;
         }
         ...
         if(this.var_338)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_566);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_241.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc3_.leftSideLoc / this.var_311.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc3_.rightSideLoc / this.var_310.length;
                  _loc12_ = _loc3_.type;
                  this.var_788.updateMask(this.var_70,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_339.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc4_.leftSideLoc / this.var_311.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc4_.rightSideLoc / this.var_310.length;
                  _loc13_ = this.var_70.width * _loc4_.leftSideLength / this.var_311.length;
                  _loc14_ = this.var_70.height * _loc4_.rightSideLength / this.var_310.length;
                  this.var_70.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1319.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_338 = false;
