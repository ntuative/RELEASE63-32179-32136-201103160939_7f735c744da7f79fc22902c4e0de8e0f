package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1384:String = "library";
      
      private static const const_1381:String = "service-libraries";
      
      private static const const_1377:String = "library";
      
      private static const const_1380:String = "component-libraries";
      
      private static const const_1383:String = "library";
      
      private static const const_1379:String = "error_data";
      
      private static const const_1378:String = "error_cat";
      
      private static const const_1382:String = "error_desc";
       
      
      private var var_387:LibraryLoaderQueue;
      
      private var var_812:IEventDispatcher;
      
      private var var_537:uint;
      
      private var var_388:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_276.push(new Array());
            this.var_659.push(0);
            _loc3_++;
         }
         this._lastUpdateTimeMs = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_395.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1228:
               debug("Core; using simple frame update handler");
               this.var_388 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_679:
               debug("Core; using complex frame update handler");
               this.var_388 = this.complexFrameUpdateHandler;
               break;
            case Core.const_740:
               debug("Core; using profiler frame update handler");
               this.var_388 = this.profilerFrameUpdateHandler;
               this.var_208 = new Profiler(this);
               attachComponent(this.var_208,[new IIDProfiler()]);
               var_395.addChild(new ProfilerViewer(this.var_208));
               break;
            case Core.const_469:
               debug("Core; using experimental frame update handler");
               this.var_388 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_388 = this.debugFrameUpdateHandler;
         }
      }
      
      public function getNumberOfFilesPending() : uint
      {
         return this.var_387.length;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc2_ = this.var_276[_loc4_] as Array;
            ...
            if(var_395)
            {
               var_395.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
               var_395 = null;
            }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1379,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1378,String(param3));
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_812 = loadingEventDelegate;
         if(this.var_387 == null)
         {
            this.var_387 = new LibraryLoaderQueue(_debug);
         }
         try
         {
         ...
         try
         {
            node = config.child(const_1381)[0];
            if(node != null)
            {
               list = node.child(const_1377);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1677);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_812)
         {
            this.var_812.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_812)
         {
            ...
            this.var_812.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_812)
                  {
                     this.var_812.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_537 - this.var_387.length,this.var_537,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_208 ? 0 : this.var_1516 & 0;
         if(_loc3_ == Core.const_469)
         {
            this.var_276[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_276[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_208 ? 0 : this.var_1516 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_102)
         {
            _loc3_ = this.var_276[_loc5_] as Array;
            if(_loc4_ == Core.const_469)
            {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_388(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_659[priority] = 0;
            receivers = this.var_276[priority];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_395.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_102)
         {
            t = getTimer();
            ...
            {
               if(this.var_659[priority] < priority)
               {
                  ++this.var_659[priority];
                  skip = true;
               }
            }
            if(!skip)
