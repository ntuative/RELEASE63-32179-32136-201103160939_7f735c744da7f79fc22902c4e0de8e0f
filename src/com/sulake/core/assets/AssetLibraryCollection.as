package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_540:Array;
      
      protected var var_1030:LoaderContext;
      
      protected var var_454:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1030 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_454 = new AssetLibrary("lib-" + this.var_547++);
         this.var_30.push(this.var_454);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1030;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_547++);
         this.var_540.push(_loc3_);
      ...
      {
         return this.var_454.loadFromResource(param1,param2);
      }
      ...
      public function unload() : void
      {
         ...
         {
            (this.var_540.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_540.length)
            {
               _loc3_ = this.var_540[_loc4_] as IAssetLibrary;
      ...
      {
         return this.var_454.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_454.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_454.createAsset(param1,param2);
      }
      ...
      {
         return this.var_454.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_454.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_454.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_454.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
