package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1139:String = "AssetLibraryReady";
      
      public static const const_759:String = "AssetLibraryLoaded";
      
      public static const const_1516:String = "AssetLibraryUnloaded";
      
      public static const const_1488:String = "AssetLibraryLoadError";
      
      private static const const_589:String = "name";
      
      private static const const_985:String = "asset";
      
      private static const const_986:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_984:String = "library";
      
      private static var var_321:Dictionary;
      
      private static var var_1967:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_536:uint = 0;
      
      private static var var_1009:Array = new Array();
      ...
      private var var_1008:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_811 = new XML();
         this.var_449 = 0;
         this.var_450 = new Array();
         if(var_321 == null)
         {
            var_321 = new Dictionary(false);
         ...
         this.var_535 = new Dictionary(false);
         this.var_1006 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_656 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_985);
            _loc11_ = _loc5_.length();
            _loc12_ = 0;
            while(_loc12_ < _loc11_)
            {
               _loc6_ = _loc5_[_loc12_];
               _loc7_ = _loc6_.attribute(const_589);
               ...
               if(_loc8_ != null)
               {
                  ...
                  _loc10_ = _loc6_.child(const_986);
                  if(_loc10_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_656 + "!");
               }
               _loc12_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1009.splice(var_1009.indexOf(this),1);
            --var_536;
            this.var_535 = null;
            this.var_1006 = null;
            this.var_171 = null;
      ...
      {
         if(this.var_656 == param1.url && this.var_1007)
         {
            if(!this.var_1008 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_811,this.var_655);
            }
            this.var_1008 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1139));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1006)
         {
            delete this.var_1006[_loc1_];
         }
         if(this.var_43 != null)
         {
            this.var_43.dispose();
         ...
         this.var_1007 = false;
         this.var_656 = null;
         dispatchEvent(new Event(AssetLibrary.const_1516));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1006[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_535[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_993,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1144,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1223,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_535[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_535[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_535[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_171[param1] != null || (this.var_655 != null ? this.var_655[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1967.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_321.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_321[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_321[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_321)
            {
               _loc3_ = AssetTypeDeclaration(var_321[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_321)
            {
               _loc4_ = AssetTypeDeclaration(var_321[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_811 = _loc2_.manifest.copy();
         this.var_655 = _loc2_.resource;
         this.var_656 = _loc2_.url;
         if(this.var_1008)
         {
            AssetLibrary.fetchLibraryContents(this,this.var_811,this.var_655);
         }
         this.var_1007 = true;
         dispatchEvent(new Event(AssetLibrary.const_759));
         dispatchEvent(new Event(AssetLibrary.const_1139));
         if(this.var_1008)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1488));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_811.child(const_984);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_589).toString() == param1)
               {
                  ...
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_656 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_655[param1]);
                  _loc6_ = _loc3_.child(const_986);
                  if(_loc6_.length())
                  {
