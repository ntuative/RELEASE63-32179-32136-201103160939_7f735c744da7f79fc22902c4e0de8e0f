package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_610:Map = new Map();
      
      private static const const_330:Map = new Map();
      
      private static var var_1177:Boolean = false;
      ...
      {
         return const_610.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1177)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_610.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1177 = true;
         }
