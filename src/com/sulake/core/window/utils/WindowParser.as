package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1175:String = "_EXCLUDE";
      
      public static const const_1934:String = "_INCLUDE";
      
      public static const const_1776:String = "_TEMP";
      
      private static const const_1241:String = "layout";
      ...
      private static const const_1257:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1242:String = "width";
      
      private static const const_1255:String = "height";
      
      private static const const_1252:String = "visible";
      
      private static const const_1254:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1078:String = "blend";
      
      private static const const_1247:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1256:String = "treshold";
      
      private static const const_1244:String = "children";
      
      private static const const_1245:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1246:String = "height_min";
      ...
      private static const const_1253:String = "$";
      
      private static const const_1249:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1250:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1265:Dictionary;
      
      protected var var_1021:Dictionary;
      
      protected var var_1527:Dictionary;
      
      protected var var_2027:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1264,this.var_1265);
         this.var_1021 = new Dictionary();
         this.var_1527 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1021,this.var_1527);
         this.var_2027 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1243,const_49);
         return param1.replace(const_1250,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1265)
            {
               delete this.var_1265[_loc1_];
            }
            for(_loc1_ in this.var_1021)
            {
               delete this.var_1021[_loc1_];
            }
            for(_loc1_ in this.var_1527)
            {
               delete this.var_1527[_loc1_];
            }
            this.var_2027.dispose();
            this.var_2027 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1241)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         tag = unescape(String(this.parseAttribute(xml,const_1257,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_158));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_158));
         rect.width = Number(this.parseAttribute(xml,const_1242,variables,const_158));
         rect.height = Number(this.parseAttribute(xml,const_1255,variables,const_158));
         visible = this.parseAttribute(xml,const_1252,variables,visible.toString()) == const_590;
         ...
         if(xml.child(const_588).length() > 0)
         {
            ...
            while(i < length)
            {
               ...
               if(this.var_1021[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_589)) + "\"!");
               }
               params |= this.var_1021[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1254,variables,caption)));
         if(tag != const_49)
         {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1245,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1246,variables,window.limits.minHeight));
         ...
         blend = Number(this.parseAttribute(xml,const_1078,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1247,variables,window.clipping.toString()) == const_590;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1256,variables,window.mouseThreshold.toString()));
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1265[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1175) == -1)
                  {
