package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1259:String = "increment";
      
      private static const const_1258:String = "decrement";
      
      private static const const_921:String = "slider_track";
      ...
      protected var var_661:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_540,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_50,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_540,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_921) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_545)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_302)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_661;
                  }
                  else
                  {
                     this.scrollV -= this.var_661;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_457)
         {
            ...
            else if(param2.name == const_1258)
            {
               if(this.var_18)
               {
                  this.var_1045 = true;
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(this.var_844 != null)
         {
            ...
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_844) as IScrollableWindow;
               if(_loc1_)
               {
