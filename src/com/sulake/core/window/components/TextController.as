package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_829:Number;
      
      protected var var_545:Number;
      
      protected var var_544:Boolean;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_202);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_741 ? true : null;
         }
      ...
      {
         this.var_829 = param1;
         this._field.scrollH = this.var_829 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_829 * this.maxScrollH,this.var_545 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_829 = this.var_829;
         _loc1_.var_545 = this.var_545;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1005) ? new PropertyStruct(PropertyDefaults.const_844,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1056) : PropertyDefaults.const_1473);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1218 ? new PropertyStruct(PropertyDefaults.const_780,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1201) : PropertyDefaults.const_1411);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1140 ? new PropertyStruct(PropertyDefaults.const_1158,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1230) : PropertyDefaults.const_1649);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_891) ? new PropertyStruct(PropertyDefaults.const_373,this._field.textColor,PropertyStruct.const_147,true) : PropertyDefaults.const_1030);
         ...
         _loc1_.push(this.var_40.left != PropertyDefaults.const_874 ? new PropertyStruct(PropertyDefaults.const_235,this.var_40.left,PropertyStruct.const_41,true) : PropertyDefaults.const_562);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_865 ? new PropertyStruct(PropertyDefaults.const_215,this.var_40.top,PropertyStruct.const_41,true) : PropertyDefaults.const_459);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_832 ? new PropertyStruct(PropertyDefaults.const_249,this.var_40.right,PropertyStruct.const_41,true) : PropertyDefaults.const_440);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_643 ? new PropertyStruct(PropertyDefaults.const_231,this.var_40.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_572);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1051 ? new PropertyStruct(PropertyDefaults.const_890,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1543);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_254,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_254,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_254,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
