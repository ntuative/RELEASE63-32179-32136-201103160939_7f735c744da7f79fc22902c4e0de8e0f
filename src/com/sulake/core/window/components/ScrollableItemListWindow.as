package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1244:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_446)
         {
            this.var_446.removeEventListener(WindowEvent.const_286,this.scrollBarEventProc);
            this.var_446.removeEventListener(WindowEvent.const_223,this.scrollBarEventProc);
            this.var_446 = null;
         }
         if(this.var_1244)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1244)
         {
            this.var_1244 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_446)
         {
            ...
            if(this.var_446)
            {
               this.var_446.addEventListener(WindowEvent.const_286,this.scrollBarEventProc);
               this.var_446.addEventListener(WindowEvent.const_223,this.scrollBarEventProc);
            }
         }
         return this.var_446;
      }
