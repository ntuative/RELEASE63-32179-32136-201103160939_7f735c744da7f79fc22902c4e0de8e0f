package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_780:Boolean = false;
      ...
      {
         this.var_1274 = param1 == null ? "" : param1;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_457)
         {
            this.focus();
         }
      ...
      protected function method_4() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_780 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_349,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_756,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1655);
         _loc1_.push(this.var_1275 != PropertyDefaults.const_1003 ? new PropertyStruct(PropertyDefaults.const_677,this.var_1275,PropertyStruct.const_39,true) : PropertyDefaults.const_1592);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1210 ? new PropertyStruct(PropertyDefaults.const_860,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1547);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1134 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1476);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_677:
                  this.var_1275 = _loc2_.value as Boolean;
                  if(this.var_1275)
                  {
