package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1361:String = "_SELECTOR";
      
      private static const const_1362:String = "_CONTENT";
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1026 = findChildByTag(const_1361) as ITabSelectorWindow;
            if(this.var_1026 != null)
            {
               this.var_1026.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2046 = findChildByTag(const_1362) as IWindowContainer;
         }
      ...
      {
         return !!this.var_780 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1026.numSelectables;
      }
