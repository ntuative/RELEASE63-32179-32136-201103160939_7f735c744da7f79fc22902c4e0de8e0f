package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1780:uint = 64;
      
      public static const const_1890:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_547:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_209.numChildren > 0)
               {
                  this.var_209.removeChildAt(0);
               }
            }
            this.var_209 = null;
            while(numChildren > 0)
         ...
         if(this.var_822)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2037,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2037,16777215);
                  }
                  var_325 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_209 == null)
         {
            this.var_209 = new Sprite();
            this.var_209.name = this.name + " - Child Container";
            this.var_209.mouseEnabled = false;
      ...
      {
         return this.var_209 != null ? int(this.var_209.numChildren) : 0;
      }
