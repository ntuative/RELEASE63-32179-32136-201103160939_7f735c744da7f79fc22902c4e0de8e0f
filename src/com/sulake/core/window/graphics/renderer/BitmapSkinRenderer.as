package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_828:Dictionary;
      
      protected var var_827:Dictionary;
      ...
      {
         super(param1);
         this.var_828 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_984 = null;
            for(_loc1_ in this.var_828)
            {
               _loc2_ = this.var_828[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_828[_loc1_];
            }
            this.var_828 = null;
            for(_loc1_ in this.var_827)
            {
               _loc2_ = this.var_827[_loc1_] as BitmapData;
               _loc2_.dispose();
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_452[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_279)
                  {
                     var_36.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_502)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_293)
                  {
                     _loc12_ = true;
                     var_36.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_279)
                  {
                     var_36.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_502)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_293)
                  {
                     _loc13_ = true;
                     var_36.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_293 || _loc10_.scaleH == SkinLayoutEntity.const_293)
                  {
                  ...
                  {
                     this.var_984.a = 0 / _loc17_.width;
                     this.var_984.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_36.width,var_36.height,false);
                     _loc30_.draw(_loc17_,this.var_984);
                     _loc31_ = new BitmapData(var_36.width,var_36.height,true,0);
                     _loc31_.draw(_loc18_,this.var_984,null);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_828[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_827[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
